        ...
        do {
            ...
            properties.forEach(key => {
                if (metadata[key].type) {
                    ...
                    field_decorator_1.addFieldMetadata(type, options, classPrototype, key, undefined, true);
                }
                else {
                    field_decorator_1.addFieldMetadata(metadata[key], undefined, classPrototype, key, undefined, true);
                }
            });
